                                ...
                                <div className='max-md:mt-[22px] md:mt-[30px] w-full max-w-full sm:max-w-[400px] md:max-w-[450px] lg:max-w-[600px] mx-auto rounded-[20px] bg-white max-sm:pt-[22px] sm:pt-[25px] md:pt-[30px] lg:pt-[40px] max-sm:px-[20px] sm:px-[25px] md:px-[30px] lg:px-[50px] max-sm:pb-[22px] sm:pb-[25px] md:pb-[30px] lg:pb-[50px]'>
                                    <form action="">
                                        <div className='mb-[20px]'>
                                            <label htmlFor="name" className="block mb-[10px] text-blue font-poppins text-[14px] font-semibold leading-normal capitalize">Full Name*</label>
                                            <input type="text" id="name" name="name" placeholder='John Doe' className="w-full rounded-[7px] border border-solid border-[#E5E5E5] bg-white max-md:py-[10px] md:py-[14px] px-[12px] text-blue font-poppins text-[14px] font-normal leading-[157%] outline-none focus:border-[#8CBC3F] placeholder:text-[#45647BCC] placeholder:font-poppins placeholder:text-[14px] placeholder:leading-[157%]"></input>
                                        </div>
                                        <div className='mb-[20px]'>
                                            <label htmlFor="email" className="block mb-[10px] text-blue font-poppins text-[14px] font-semibold leading-normal capitalize">Email*</label>
                                            <input type="email" id="email" name="email" placeholder='johndoe@gmail.com' className="w-full rounded-[7px] border border-solid border-[#E5E5E5] bg-white max-md:py-[10px] py-[14px] px-[12px] text-blue font-poppins text-[14px] font-normal leading-[157%] outline-none focus:border-[#8CBC3F] placeholder:text-[#45647BCC] placeholder:font-poppins placeholder:text-[14px] placeholder:leading-[157%]"></input>
                                        </div>
                                        <div className='mb-[20px]'>
                                        ...
                                        <div>
                                            <label for="message" className="block mb-[10px] text-blue font-poppins text-[14px] font-semibold leading-normal capitalize">Message</label>
                                            <textarea id="message" name="message" placeholder='Tell us more' className="w-full rounded-[7px] border border-solid border-[#E5E5E5] bg-white pt-[14px] pb-[57px] px-[12px] text-blue font-poppins text-[14px] font-normal leading-[157%] outline-none focus:border-[#8CBC3F] placeholder:text-[#45647BCC] placeholder:font-poppins placeholder:text-[14px] placeholder:leading-[157%]"></textarea>
                                        </div>
