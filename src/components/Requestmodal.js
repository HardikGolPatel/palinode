                        ...
                        <div className='container'>
                            <div>
                                ...
                                <div className='max-md:mt-[25px] md:mt-[40px]'>
                                    <span className='block text-center text-blue font-poppins max-md:text-[22px] md:text-[26px] font-semibold leading-normal capitalize'>Request a demo</span>
                                </div>
                                <div className='max-md:mt-[22px] md:mt-[30px] w-full max-w-full sm:max-w-[400px] md:max-w-[450px] lg:max-w-[600px] mx-auto rounded-[20px] bg-white max-sm:pt-[22px] sm:pt-[25px] md:pt-[30px] lg:pt-[40px] max-sm:px-[20px] sm:px-[25px] md:px-[30px] lg:px-[50px] max-sm:pb-[22px] sm:pb-[25px] md:pb-[30px] lg:pb-[50px]'>
                                    <form action="">
                                        ...
                                        <div className='mb-[20px]'>
                                            <label for="name2" class="block mb-[10px] text-blue font-poppins text-[14px] font-semibold leading-normal capitalize">Company</label>
                                            <input type="text" id="name2" name="name2" placeholder='Vertex Innovations' class="w-full rounded-[7px] border border-solid border-[#E5E5E5] bg-white max-md:py-[10px] md:py-[14px] px-[12px] text-blue font-poppins text-[14px] font-normal leading-[157%] outline-none focus:border-[#8CBC3F] placeholder:text-[#45647BCC] placeholder:font-poppins placeholder:text-[14px] placeholder:leading-[157%]"></input>
                                        </div>
                                        <div className='mb-[20px]'>
                                        ...
                                        <div>
                                            <label for="message" class="block mb-[10px] text-blue font-poppins text-[14px] font-semibold leading-normal capitalize">Additional Information</label>
